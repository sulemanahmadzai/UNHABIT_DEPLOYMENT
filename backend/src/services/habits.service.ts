 ...
 */
export async function getHabitTriggers(userId: string, habitId: string) {
  const habit = await db.user_habits.findFirst({
    where: {
      id: habitId,
      user_id: userId,
 ...
 */
export async function addTriggerToHabit(
  userId: string,
  habitId: string,
  triggerId: string
) {
 ...
 */
export async function removeTriggerFromHabit(
  userId: string,
  habitId: string,
  triggerId: string
) {
