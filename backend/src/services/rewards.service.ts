 ...
 * Get earned rewards
 */
export async function getEarnedRewards(userId: string) {
...
export async function awardBadge(
  ...
  return db.user_badges.upsert({
    ...
    create: {
      user_id: userId,
      badge_id: badgeId,
      evidence: evidence ? (evidence as Prisma.InputJsonValue) : Prisma.JsonNull,
    },
    update: {},
    include: {
      badge_definitions: true,
 ...
 * Get today's XP
 */
export async function getTodayXP(userId: string) {
 ...
 */
export async function getNextBadge(userId: string) {
