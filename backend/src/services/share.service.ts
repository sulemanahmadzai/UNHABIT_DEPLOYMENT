 ...
 */
export async function generateProgressShare(userId: string) {
 ...
 */
export async function generateAchievementShare(
  userId: string,
  achievementType: "badge" | "streak" | "level" | "journey_complete",
  ...
  let achievementData: Record<string, unknown> = {};
  let title = "";
  let description = "";
