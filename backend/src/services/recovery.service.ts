 ...
 */
export async function checkMissedDay(userId: string) {
 ...
 */
export async function continueWithPenalty(userId: string) {
 ...
 */
export async function useProtection(userId: string) {
