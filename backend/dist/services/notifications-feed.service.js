...
export async function getNotifications(userId, options = {}) {
    ...
    if (buddyLinkIds.length > 0) {
        ...
        const buddyNotifications = buddyNudges.map((nudge) => {
        ...
        const allNotifications = [...notifications, ...buddyNotifications].sort((a, b) => b.created_at.getTime() - a.created_at.getTime());
...
//# sourceMappingURL=notifications-feed.service.js.map