...
// ==================== HABIT TEMPLATES ====================
export async function getTemplates(categoryId) {
...
export async function updateBadgeDefinition(id, data) {
    return prisma.badge_definitions.update({
        where: { id },
        data: removeUndefined(data),
    });
}
export async function deleteBadgeDefinition(id) {
    return prisma.badge_definitions.delete({
        where: { id },
    });
}
// ==================== BADGE RULES ====================
export async function getBadgeRules(badgeId) {
...
export async function updateBadgeRule(id, data) {
    return prisma.badge_rules.update({
        where: { id },
        data: removeUndefined(data),
    });
}
export async function deleteBadgeRule(id) {
    ...
    try {
        return await prisma.point_rules.create({
            data: {
                ...
                amount: data.amount,
                caps: (data.caps ?? Prisma.JsonNull),
...
export async function updatePointRule(id, data) {
...
export async function upsertAppSetting(key, data, updatedBy) {
